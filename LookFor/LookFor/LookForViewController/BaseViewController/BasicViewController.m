...
- (void)viewDidLoad
{
    ...
    startHeight = 0.0;
    //设置页面背景
    self.view.backgroundColor =  [UIColor clearColor];//BASIC_VIEW_BG_COLOR;
    
    //设置导航条
    [self.navigationController.navigationBar setBackgroundImage:[CommonTool imageWithColor:[UIColor blueColor]] forBarMetrics:UIBarMetricsDefault];
...
- (void)setNavBarItemWithTitle:(NSString *)title navItemType:(NavItemType)type selectorName:(NSString *)selName
{
    ...
    button.titleLabel.font = [UIFont systemFontOfSize:17]; //FONT(17.0);
